...
echo("<center><font size='-1'>
	$lang[update_vote_4] <a href='?q=$id'>#$id</a>.
      <br /></font> </center>");
}
...
global $lang;
  echo("<center><font size='-1'>");
    if($type=="downgraded"){
	echo("$lang[update_vote_1] <a href='?q=$id'>#$id</a> $lang[update_vote_2]<br />");
    } else if($type=="upgraded"){
	echo("$lang[update_vote_1] <a href='?q=$id'>#$id</a> $lang[update_vote_3]<br />");
    } else if($type=="sux"){
